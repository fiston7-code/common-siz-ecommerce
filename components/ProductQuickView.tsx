                ...
                <div className="flex flex-col">
                  ...
                  <div className="mb-6 pb-6 border-b border-gray-200">
                    <div className="flex flex-col gap-2">
                      {/* Prix principal selon la devise sélectionnée */}
                      <div className="flex items-baseline gap-3">
                        <span className="text-4xl font-bold text-gray-900">
                        {formatPrice(product.price_usd, 'USD')}
                        </span>
                        {/* <span className="text-sm text-gray-500 font-medium">
                          {currency === 'FC' ? '(Francs Congolais)' : '(Dollars US)'}
                        </span> */}
                      </div>
                      
                      {/* Prix secondaire (équivalent dans l'autre devise) */}
                      ...
                      {/* ✅ AJOUT : Prix en dollars toujours visible */}
                      {currency === 'FC' && (
                        <div className="mt-2 pt-2 border-t border-gray-100">
                          <div className="flex items-center gap-2 text-blue-600 font-semibold">
                            <span className="text-2xl">{formatPrice(product.price_usd, 'USD')}</span>
                            <span className="text-sm">(Prix en USD)</span>
                          </div>
                        </div>
                      )}
                    </div>
